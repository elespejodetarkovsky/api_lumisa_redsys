...
use App\Model\message\RESTAuthenticationRequestMessage;
use App\Model\message\RESTInitialRequestMessage;
use App\Model\message\RESTOperationMessage;
use App\Service\Impl\RESTAuthenticationRequestService;
use App\Service\Impl\RESTInitialRequestService;
use App\Service\Impl\RESTOperationService;
...
class HomeController extends AbstractController
{
    ...
    {
        //include_once '../Init/initRedsysApi.php';
    }
    ...
    #[Route('/3DSecureV1CardData', name: '3dsecure_v1_card_data')]
    public function threedSecureV1CardData(): Response
    {
